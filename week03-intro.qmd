...
author: "Amber Camp (edited by Kanani Tim Sing)"
date: "2025-09-08"
format: html
editor: visual
---
...
Start by exploring the data below. It's always good to ensure you understand what is contained in your dataset.oinsovmnksnvksikvn
...
-   What variables look interesting?
    -   only 3 gears, some cars donʻt exist anymore
...
Create a scatterplot and histogram and boxplot of two variables of your choice (but not `mpg` vs. `wt`). Feel free to try a `ggplot2` version if you have some R experience!
