...
Answer: histogram= continuous data vs Bar chart= categorical data
...
atk_boxplot <- ggplot(data = pokedata, aes(x = sp_atk)) + (y = 1)
  geom_boxplot()
...
def_boxplot <- ggplot(data = pokedata, aes(x = sp_def)) + (y = 1)
  geom_boxplot()
